...
func (r *TaskRepository) CreateTask(ctx context.Context, task domain.Task) (domain.Task, error) {
	...
	query := `INSERT INTO todoapp.tasks (title, description, completed, created_at, completed_at, author_user_id) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id, version, title, description, completed, created_at, completed_at, author_user_id;`
